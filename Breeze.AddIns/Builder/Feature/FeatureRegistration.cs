...
{
    /// <summary>
    /// Defines methods for a representation of registered features of the App.
    /// </summary>
	...
	/// <summary>
	/// Feature registration by Type.  This version is primarily used by the AddIn system.
	/// Users should prefer the derived generic version of these methods.
	/// </summary>
	internal class FeatureRegistrationByType : IFeatureRegistration {
		...
		public FeatureRegistrationByType(Type type) {
		...
		public void BuildFeature(IServiceCollection serviceCollection) {
			...
			serviceCollection
				...
				.AddSingleton(typeof(IAppFeature), provider => provider.GetService(this.FeatureType));
	...
	internal class FeatureRegistration<TImplementation> : FeatureRegistrationByType where TImplementation : class, IAppFeature
    {
        /// <summary>Initializes the instance of the object.</summary>
        public FeatureRegistration(): base(typeof(TImplementation))
        {
        }
    }
}